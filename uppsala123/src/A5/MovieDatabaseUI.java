...
public class MovieDatabaseUI {
	...
	Movies moviesDatabase = new Movies();
	/**
	...
	private void addMovie() {
		...
		moviesDatabase.movies.put(title,List.of(realScoreIPromiseLawl));
