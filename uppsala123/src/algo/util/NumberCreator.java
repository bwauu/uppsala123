...
public class NumberCreator {
	 ...
	 * @return
	 */
	public static final List<Integer> createNumberList(int n, int lowerBound, int upperBound, boolean random) {
	 ...
	 * @return
	 */
	public static final int[] createNumberArray(int n, int lowerBound, int upperBound, boolean random) {
